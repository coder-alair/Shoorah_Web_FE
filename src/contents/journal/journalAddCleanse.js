...
const pages = [
  ...
  { name: "Add Cleanse", href: "/journal/add-cleanse", current: true },
];

export default function JournalCleanse() {
  ...
  return (
    <div className={`${audioNav && `mb-[2rem]`} pb-[13vh] lg:pb-0`}>
      <Navbar />
      <Hero hideInfo={true} heading={`Add Cleanse`} />
      <SideMenu />
      {loader && <Loader />}
              ...
              <div className="flex flex-col justify-around gap-3">
                <div className="flex flex-col justify-around gap-5 sm:flex-row">
                  <div
                    ...
                    } relative flex aspect-square h-20 w-20 cursor-pointer items-center justify-center gap-4 rounded-2xl lg:h-[12rem] lg:w-[16rem] lg:rounded-[2rem]`}
                  >
                    {!preview && (
                      <p className="absolute left-0 top-[-2.5rem] whitespace-nowrap text-base lg:left-[10px] lg:text-xl">
                        Add Image
                      </p>
                    )}
                    {!preview && (
                ...
                <div className="w-[100%]">
                  <div className="relative flex flex-col gap-2">
                    <label
                      htmlFor="description"
                      className="mt-2 text-base lg:ml-5 lg:text-xl"
                    >
                      Description
                    </label>
                    ...
                    <textarea
                      ...
                      className={`P22Mackinac placeholder:P22Mackinac h-[10rem] w-[100%] resize-none appearance-none break-all rounded-[2rem] border border-gray-300 px-4 py-2 pl-16 pt-3 text-base placeholder-[#000] placeholder:font-[500] placeholder:tracking-wider lg:h-[25rem] lg:pt-5 lg:text-lg ${theme.shoorah_border_focus_5} focus:outline-none ${theme.shoorah_border_ring_focus_5} sm:text-lg`}
                    />
