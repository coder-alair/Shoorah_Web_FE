...
const pages = [
  ...
  { name: "Add Notes", href: "/journal/add-notes", current: true },
];
            ...
            axios
              ...
              .then((res) => {
                if (res.status == 200) {
                  ...
                  setText("");
                  setTitle("");
                  successToast("Note is created successfully !");
                  setLoader(false);
