...
import ShoorahAffirmations from "./shoorahAffirmation";
import BackButton from "../reusable/backButton";

const pages = [
  { name: "journal", href: "/journal", current: false },
  { name: "Affirmation", href: "/journal/affirmation", current: true },
];
...
export default function Affirmation() {
  ...
  return (
    <div className="relative h-full overflow-hidden pb-[13vh] lg:pb-0">
      <Navbar />
      <Hero hideInfo={true} heading={`My Affirmations`} />
      <SideMenu />

      {loader && <Loader />}
      <div className="mx-auto mt-4 h-[100%] w-[100%]  lg:mt-10 lg:w-[70vw] xl:w-[80vw]">
        <div className="w-full">
          <div className="flex flex-col items-center justify-between px-4 py-3 xl:px-10">
            <div className="relative mt-2 flex w-full items-center justify-center xl:mt-[2rem] xl:gap-[5rem]">
              <BackButton />
              <div
                onClick={() => setTab(0)}
                className={
                  tab == 0
                    ? `rounded-[3rem] text-lg font-medium lg:text-xl ${theme.shoorah_bg_1}  flex  items-center justify-center px-4 py-1 text-center md:px-12 lg:px-16 lg:py-3 ${theme.shoorah_text_5} P22Mackinac ease cursor-pointer duration-1000`
                    : `rounded-[3rem] text-lg font-medium lg:text-xl ${theme.inactiveToggleText} P22Mackinac ease flex  cursor-pointer  items-center justify-center px-4 py-1 text-center duration-1000 md:px-12 lg:px-16 lg:py-3`
                }
              >
                My Affirmations
              </div>
          ...
          {tab == 0 ? <MyAffirmations /> : <ShoorahAffirmations />}
        </div>
      </div>

      <div
        style={{ rotate: "20deg" }}
        className={`absolute right-[-15%] top-[15rem]  z-[-3] w-[14rem] md:w-[20rem] lg:w-[28rem]`}
      >
        <svg
          // width={1440}
          // height={1440}
      ...
      <div
        style={{ rotate: "20deg" }}
        className={`absolute left-[-15%] top-[310rem] z-[-3] w-[14rem] md:w-[20rem] lg:w-[28rem]`}
      >
        <svg
          // width={1440}
          // height={1440}
      ...
      <div
        style={{ rotate: "20deg" }}
        className={`absolute right-[-15%] top-[380rem]  z-[-3]  w-[14rem] md:w-[20rem] lg:w-[28rem]`}
      >
        <svg
          // width={1440}
          // height={1440}
      ...
      <div
        style={{ rotate: "20deg" }}
        className={`absolute left-[-15%] top-[430rem] z-[-3] w-[14rem] md:w-[20rem] lg:w-[28rem]`}
      >
        <svg
          // width={1440}
          // height={1440}
      ...
      <div
        style={{ rotate: "60deg" }}
        className={`absolute right-[-15%] top-[510rem] z-[-3] w-[14rem] md:w-[20rem] lg:w-[28rem]`}
      >
        <svg
          // width={1440}
          // height={1440}
