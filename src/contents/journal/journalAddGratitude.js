...
const pages = [
  ...
  { name: "Add Gratitude", href: "/journal/add-gratitude", current: true },
];
...
export default function JournalGratitude() {
      ...
      Api.addGratitude(payload).then((res) => {
        ...
        if (res.status == 200) {
          if (res?.data?.meta?.uploadURL) {
            console.log(res.data.meta.uploadURL);
            axios
              ...
              .then((res) => {
                if (res.status == 200) {
                  ...
                  setText("");
                  setTitle("");
                  successToast("Gratitude is created successfully !");
  ...
  return (
    <div className={`${audioNav && `mb-[2rem]`} pb-[13vh] lg:pb-0`}>
      <Navbar />
      <Hero hideInfo={true} heading={`Add Gratitude`} />
      <SideMenu />
      {loader && <Loader />}
              ...
              <div className="flex flex-col justify-around gap-3">
                <div className="flex flex-col justify-around gap-5 sm:flex-row">
                  ...
                  <div className="relative flex w-full flex-col gap-2 self-end">
                    ...
                    <span
                      onClick={handleClick}
                      className="absolute right-[5px] top-[0.5rem] hidden cursor-pointer text-black hover:scale-110"
                    >
                      {" "}
                      <svg
                        width="26"
                    ...
                    {error?.title && (
                      <span className={`error text-sm  text-[red]`}>
                        {error?.title}
                      </span>
                    )}
                  </div>
                ...
                <div className="w-[100%]">
                  <div className="relative flex flex-col gap-2">
                    ...
                    {error?.description && (
                      <span className={`P22Mackinac error text-sm  text-[red]`}>
                        {error?.description}
                      </span>
                    )}
                  </div>
