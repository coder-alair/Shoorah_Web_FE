...
const EditAffirmation = () => {
  ...
  let affirmation = location.state;
  const [text, setText] = useState(affirmation.description);
  const [title, setTitle] = useState(affirmation.title);
  const [preview, setPreview] = useState(affirmation.imageUrl);
            ...
            axios
              ...
              .then((res) => {
                if (res.status == 200) {
                  ...
                  setText("");
                  setTitle("");
                  successToast("Affirmation is updated successfully !");
        ...
        if (res.status == 200) {
          if (res?.data?.meta?.uploadURL) {
            ...
            if (res?.data?.meta?.code == 1) {
              ...
              setPreview(null);
              setTitle("");
              successToast("Draft is Saved Successfully");
              history.replace("/journal/affirmation");
              setLoader(false);
            } else {
              setImage(null);
            ...
            <div className="py-[6rem]">
              <div className="flex flex-col justify-around gap-3">
                <div className="flex flex-col justify-around gap-5 sm:flex-row">
                  ...
                  <div className="relative flex w-full flex-col gap-2 self-end">
                    ...
                    <div className="relative w-full">
                      <div className="pointer-events-none absolute left-[-1.5rem] top-[1.3rem] z-10 flex items-center pl-12">
                        <svg
                          width="24"
                          height="24"
                          viewBox="0 0 18 18"
                      ...
                      <input
                        ...
                        className={`P22Mackinac placeholder:P22Mackinac relative block w-[100%] appearance-none rounded-[3rem] border border-gray-300 px-4  py-5 pl-16 text-lg placeholder-[#000] placeholder:text-lg placeholder:font-[500] placeholder:tracking-wider ${theme.shoorah_border_focus_5} focus:outline-none ${theme.shoorah_border_ring_focus_5}`}
                      />
                    </div>
                ...
                <div className="w-[100%]">
                  <div className="relative flex flex-col gap-2">
                    ...
                    <textarea
                      ...
                      className={`P22Mackinac placeholder:P22Mackinac h-[25rem] w-[100%] resize-none appearance-none break-all rounded-[2rem] border border-gray-300 px-4 py-2 pl-16 pt-5 placeholder-[#000] placeholder:text-lg placeholder:font-[500] placeholder:tracking-wider ${theme.shoorah_border_focus_5} focus:outline-none ${theme.shoorah_border_ring_focus_5} sm:text-lg`}
                    />
                ...
                <div className=" mt-8 flex w-full justify-around gap-[1rem] text-center sm:gap-[3rem] lg:gap-[8rem]">
                  <button
                    onClick={handleDraft}
                    className="P22Mackinac w-[50%] rounded-[3rem] border border-[gray] border-transparent bg-[#fff] py-3 text-xl font-medium text-[#000] shadow-sm hover:bg-[gray] hover:text-white focus:outline-none focus:ring-2 focus:ring-[gray] focus:ring-offset-2 sm:py-3"
                  >
                    Draft
                  </button>
                  <button
                    type="submit"
                    name="submit"
                    className={`w-[50%] border border-transparent ${theme.shoorah_bg_5} ${theme.shoorah_bg_hover_6} P22Mackinac rounded-[3rem] py-2 text-xl font-medium text-white shadow-sm focus:outline-none  focus:ring-2 sm:py-3 ${theme.shoorah_border_ring_focus_5} focus:ring-offset-2`}
                  >
                    Save
                  </button>
                </div>
