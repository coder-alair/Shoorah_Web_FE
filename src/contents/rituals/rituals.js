...
import RitualContainer from "./ritualContainer";
import ShoorahRituals from "./shoorahRituals";
...
const Rituals = () => {
  ...
  return (
    <div
      className={` ${
        audioNav && `mb-[8rem]`
      } relative w-full overflow-hidden pb-[13vh] lg:pb-0`}
    >
      <Navbar />
      <SideMenu />
      ...
      <div className="relative mx-auto mt-[3.5rem] flex w-full  items-center justify-center gap-4 px-4 xl:w-[70%] xl:gap-[5rem] xl:px-0">
        <div
          onClick={() => setTab(0)}
          className={
            tab == 0
              ? `rounded-[2rem] ${theme.shoorah_bg_1}  flex w-1/2 items-center justify-center py-1 lg:py-3 xl:px-16 ${theme.shoorah_text_5} P22Mackinac ease cursor-pointer text-lg font-medium duration-1000 lg:text-xl`
              : `rounded-[2rem] text-lg font-medium lg:text-xl ${theme.inactiveToggleText} P22Mackinac ease flex w-1/2 cursor-pointer items-center justify-center py-1 duration-1000 lg:py-3 xl:px-16`
          }
        >
          My Rituals
        </div>
