...
const TrendCarsoeul = ({ data, left }) => {
  ...
  function NextArrow(props) {
    ...
    return (
      <button
        onClick={onClick}
        className={`h-5 w-5 ${className.includes("disable") && "opacity-25"
  ...
  function PrevArrow(props) {
    ...
    return (
      <button
        onClick={onClick}
        className={`z-10 h-5 w-5 ${className.includes("disable") && "opacity-25"
  ...
  return (
    <div className="relative  mx-auto w-[90%] 2xl:w-[90%]">
            ...
            >
              {i.contentType == 3 ? (
                ...
                <div
                  ...
                  className="ml-[1rem] mt-[2rem] h-[24rem] w-[15rem] cursor-pointer"
                  key={i.contentId}
                >
                  <ConfirmPopup
                    open={affirPopup}
                ...
                onClick={() =>
                  ...
                  className=" ml-[1rem] aspect-square  w-full cursor-pointer xl:h-[24rem] xl:w-[15rem]"
                  key={i.contentId}
                >
      ...
      <button
        className="absolute -left-6 top-[35%] z-10 hidden xl:block"
      ...
      <button
        className="absolute -right-6 top-[35%] z-10 hidden xl:block"
